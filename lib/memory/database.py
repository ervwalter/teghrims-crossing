"""
campaign_memory.py — SQLite database management for campaign encyclopedia
=====================================================================
Purpose
-------
...
* Auto‑seeds the DB on first run with the starter article stubs.
* Database operations, utilities, and initialization functions.
"""
...
def latest_revision_for_date(slug: str, cutoff: date) -> Tuple[Optional[str], Optional[float]]:
    """Given a slug and cutoff date, return the most recent version and timestamp as of that date.
    
    Args:
        slug: The article slug
        cutoff: The date to get the article as of
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*80}\nCampaign Memory Database Self-Test\n{'='*80}")
